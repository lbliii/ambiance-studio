...
The `view` commands, dual initialization, named-view renders and paired proofs are implemented. Review-view selection, paired iteration and view-specific feedback in this table remain implementation targets:
